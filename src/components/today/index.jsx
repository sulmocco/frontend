                  ...
                  >
                    ...
                    <div className="bottom">
                      ...
                      <div className="counterWrap">
                        <img
                          src="/images/icon_favorite.svg"
                          alt="heart"
                          width="18"
                        />
                        {today[1].likecount} <Separator />
                        <img src="/images/icon_eye.svg" alt="eye" width="18" />
                        {today[1].viewcount}
                      </div>
