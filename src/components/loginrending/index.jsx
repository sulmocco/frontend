    ...
    <Rending>
      <RendingSection color="#fff">
        <RendingCont>
          <div className="desc">
            ...
            <h3>오늘의 술친구는 누구?</h3>
            <p>
              언제 어디서나 장소에 구애받지 않는 신개념 술자리
              <br />
              친구와 함께 즐길 수도, 다른 사람의 술자리를 지켜볼 수도 있어요
            </p>
          </div>
          <img
            src="/images/img_meta.webp"
            width="982"
            height="634"
            alt="메인이미지"
          />
          <SignUpButton mt="8.1rem" onClick={() => navigate(`/login`)}>
            로그인
          </SignUpButton>
          <p className="signup" onClick={() => navigate(`/terms`)}>
            회원가입
          </p>
        </RendingCont>
      </RendingSection>
      <RendingSection>
        <RendingContRow style={{ paddingBottom: "13.6rem" }}>
          <img
            src="/images/img_rending_01.webp"
            width="560"
            height="420"
            alt="이미지"
          />
      ...
      <RendingSection>
        <RendingContRow style={{ paddingTop: "0" }}>
          ...
          <img
            src="/images/img_rending_02.webp"
            width="569"
            height="420"
            alt="이미지"
          />
