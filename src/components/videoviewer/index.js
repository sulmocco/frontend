                ...
                this.getToken().then((token) => {
                    ...
                    mySession
                        ...
                        .then(async () => {
                            ...
                            let camera = this.props?.selectedDevices?.video?.deviceId || videoDevices[0].deviceId
                            let microphone = this.props?.selectedDevices?.audio?.deviceId || audioDevices[0].deviceId
